...
export const zh = {
  ...
  'panel.blockAtEnd': '再按 Ctrl+↓ 跳到第一个差异块',
  'panel.blockAtStart': '再按 Ctrl+↑ 跳到最后一个差异块',
...
export const en = {
  ...
  'panel.blockAtEnd': 'Press Ctrl+↓ again to jump to the first diff block',
  'panel.blockAtStart': 'Press Ctrl+↑ again to jump to the last diff block',
