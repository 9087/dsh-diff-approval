...
export const zh = {
  ...
  'discussion.lost': '这段代码已经改动，批注的锚点找不到了（不能再评论，可删除）。',
...
export const en = {
  ...
  'discussion.lost': 'This code has changed and the annotation no longer anchors to it (it cannot be commented on again; delete it if it is done).',
