...
export const zh = {
  ...
  'panel.splitMode': '双栏 diff',
  'panel.splitModeDesc': '开启后整文件 diff 用左「改前」｜右「当前」双栏、逐行对齐的视图展示，默认关闭使用单栏（合并）视图。',
...
export const en = {
  ...
  'panel.splitMode': 'Split diff',
  'panel.splitModeDesc': 'When on, the whole-file diff renders as a side-by-side (left "before" | right "current") line-aligned view. Off (default) uses the single-column unified view.',
